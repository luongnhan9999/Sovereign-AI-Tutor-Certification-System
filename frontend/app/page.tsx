    ...
    <>
      <main className="main-container">
        ...
        <section className="hero-section">
          <div className="hero-badge" style={{ borderColor: 'var(--glass-border)', color: 'var(--text-primary)', background: 'var(--glass-bg)' }}>
            <span className="hero-badge-dot" style={{ background: 'var(--accent-cyan)', boxShadow: '0 0 10px var(--accent-cyan)' }}></span>
            SYSTEM ONLINE
          </div>
          ...
          <div className="hero-actions">
            <Link href="/dashboard" className="btn-primary" style={{ background: 'var(--text-primary)', color: 'var(--bg-primary)' }}>
              Establish Link
        ...
        <section id="features" style={{ perspective: '1000px' }}>
          <div className="bento-grid">
            ...
            <div className="bento-item bento-medium">
              <div className="bento-icon" style={{ background: 'rgba(255, 215, 0, 0.05)', color: 'var(--accent-gold)' }}>🏆</div>
